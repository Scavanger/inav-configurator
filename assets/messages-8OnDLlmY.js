...
\r
    ...
    "tabJavaScriptProgramming": {\r
        "message": "JavaScript编程"\r
    },\r
    "javascriptProgrammingDescription": {\r
        "message": "编写JavaScript代码来控制您的飞行器。转译器会将您的代码转换为INAV逻辑条件。"\r
    },\r
    "javascriptBetaWarning": {\r
        "message": "<strong>编写JavaScript，获取INAV逻辑条件！</strong>使用熟悉的JavaScript语法，具有完整的自动补全和错误检查功能。<strong>目前处于测试阶段，请勿用于安全关键应用！</strong>"\r
    },\r
    "javascriptEditorTitle": {\r
        "message": "JavaScript编辑器（shift-ctrl-v粘贴，右键单击变量可重命名）"\r
    },\r
