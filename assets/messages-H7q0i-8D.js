const n=`{\r
    ...
    "serialrx_frSkyPitchRollLabel": {\r
        "message": "Використовувати сенсори тангажа та крену в телеметрії"\r
    },\r
    "serialrx_frSkyPitchRollHelp": {\r
        "message": "Це надсилає телеметрію кутів тангажа та крену замість стандартних сирих даних датчиків акселерометра. Потрібно <strong>увімкнути</strong>, якщо використовуються панелі телеметрії з LUA-скриптів для INAV під OpenTX/EdgeTX або ETHOS."\r
    },\r
    "serialrx_frSkyFuelUnitLabel": {\r
        "message": "Одиниці виміру пального SmartPort"\r
    },\r
    "serialrx_frSkyFuelUnitHelp": {\r
        "message": "Виберіть дані, які потрібно надсилати на телеметричний датчик <strong>пального</strong>."\r
    },\r
    ...
    "configurationFrSkyOptions_HELP": {\r
        "message": "Ці параметри забезпечують швидкий доступ до налаштування телеметричних датчиків SmartPort для роботи з телеметричними LUA-скриптами OpenTX/EdgeTX та ETHOS. Зверніть увагу: якщо ви використовуєте SBUS, необхідно налаштувати телеметрію SmartPort на окремому послідовному порту."\r
    },\r
    ...
    "portsMSPWarning": {\r
        "message": "<strong>Увага:</strong><p>Увімкнення MSP більш ніж на двох UART-портах може заважати роботі USB-з’єднання. Рекомендується вимкнути MSP на порту, де він не потрібен.</p>"\r
    },\r
    ...
    "osd_custom_element_settings_HELP": {\r
        "message": "Для вичерпної інформації про те, як використовувати користувацькі OSD елементи. Натисніть цей ?"\r
    },\r
    ...
    "osdElement_VERTICAL_SPEED_INDICATOR": {\r
        "message": "Індикатор вертикальної швидкості"\r
    },\r
    ...
    "osdPanServoRangeDecadegrees_HELP": {\r
        "message": "Кут обертання сервопривода панорамування. Сервопривід з кутом обертання 180 градусів зазвичай потребує значення 180 для цього параметра. Задайте від’ємне значення, щоб інвертувати напрямок обертання."\r
    },\r
    ...
    "mixer_control_profile_linking": {\r
        "message": "Профіль керування використовуватиме той самий індекс, що і профіль мікшера"\r
    },\r
    "mixer_control_profile_linking_hint": {\r
        "message": "mixer_control_profile_linking: Увімкніть для обох профілів мікшера, якщо ви хочете, щоб перемикання профілів керування виконувалося разом із перемиканням профілів мікшера (рекомендується для VTOL або змішаних типів платформ)"\r
    },\r
    "blackboxFields": {\r
    ...
    "tabJavaScriptProgramming": {\r
        "message": "Програмування на JavaScript"\r
    },\r
    "javascriptProgrammingDescription": {\r
        "message": "Пишіть код на JavaScript для керування літальним апаратом. Транспілятор перетворює ваш код на логічні умови INAV."\r
    },\r
    "javascriptBetaWarning": {\r
        "message": "<strong>Пишіть на JavaScript, отримуйте логічні умови INAV!</strong> Використовуйте звичний синтаксис JavaScript з повним автодоповненням та перевіркою помилок. <strong>Наразі в стадії бета-тестування. Не використовуйте для критично важливих застосунків!</strong>"\r
    },\r
    "javascriptEditorTitle": {\r
        "message": "Редактор JavaScript (shift-ctrl-v щоб вставити, правий клік по змінній для перейменування)"\r
    },\r
    "javascriptLoadExample": {\r
        "message": "Завантажити приклад:"\r
    },\r
    "javascriptSelectExample": {\r
        "message": "-- Оберіть приклад --"\r
    },\r
    "javascriptTranspile": {\r
        "message": "Транспілювати в INAV"\r
    },\r
    "javascriptLoad": {\r
        "message": "Завантажити з польотного контролера"\r
    },\r
    "javascriptSave": {\r
        "message": "Зберегти до польотного контролера"\r
    },\r
    "javascriptClear": {\r
        "message": "Очистити редактор"\r
    },\r
    "javascriptOutputTitle": {\r
        "message": "Вихідні дані логічних умов INAV"\r
    },\r
    "javascriptLcCount": {\r
        "message": "$1 / $2 ЛУ"\r
    },\r
    "javascriptOptimizationsApplied": {\r
        "message": "Застосовані оптимізації:"\r
    },\r
    "javascriptApiReference": {\r
        "message": "Довідник з API та приклади"\r
    },\r
    "javascriptQuickReference": {\r
        "message": "Короткий довідник"\r
    },\r
    "javascriptFlightParameters": {\r
        "message": "Параметри польоту (тільки читання)"\r
    },\r
    "javascriptRcChannels": {\r
        "message": "Канали пульта"\r
    },\r
    "javascriptOverrides": {\r
        "message": "Перевизначення (запис)"\r
    },\r
    "javascriptGlobalVariables": {\r
        "message": "Глобальні змінні"\r
    },\r
    "javascriptCompleteExample": {\r
        "message": "Повний приклад"\r
    }\r
}\r
`;export{n as default};
