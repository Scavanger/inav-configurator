...
\r
        $("a.sticks").on('click', function () {\r
            var mspWin = window.open("tabs/receiver_msp.html", "receiver_msp", "width=420,height=760,menubar=no,contextIsolation=no,nodeIntegration=yes");\r
            \r
            mspWin.window.setRawRx = function (channels) {\r
...
\r
        /* Drop MSP control sticks for now, needs more work\r
