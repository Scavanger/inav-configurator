                ...
                <div class="content_wrapper">\r
                    <div class="note" style="margin-bottom: 10px;">\r
                        <div class="note_spacer">\r
                            ...
                            <p i18n="javascriptBetaWarning"></p>\r
                        </div>\r
                    </div>\r
                </div>\r
            </div>\r
...
\r
        ...
        <div class="section">\r
            <div class="gui_box grey">\r
                <div class="gui_box_titlebar">\r
                    <div class="spacer_box_title" i18n="javascriptEditorTitle"></div>\r
                    <div class="spacer_box_title" style="margin-left: auto;">\r
                       <div class="examples-section" id="js-example-select">\r
                           <label for="examples-select" i18n="javascriptLoadExample"></label>\r
                           <select id="examples-select" class="select-example">\r
                               <option value="" i18n="javascriptSelectExample"></option>\r
                           </select>\r
                       </div>\r
\r
                    </div>\r
...
\r
        ...
        <div class="section">\r
            <div class="gui_box grey">\r
                <div class="gui_box_titlebar">\r
                    <div class="spacer_box_title" i18n="javascriptOutputTitle"></div>\r
                    <div class="spacer_box_title" style="margin-left: auto;">\r
...
\r
                    ...
                    <div id="optimization-stats" class="optimization-stats" style="display: none; margin-top: 10px;">\r
                        <div class="note">\r
                            <div class="note_spacer">\r
                                <strong i18n="javascriptOptimizationsApplied"></strong>\r
        ...
        <div class="section">\r
            <div class="gui_box grey">\r
                <div class="gui_box_titlebar">\r
                    <div class="spacer_box_title">\r
                        <a href="#" id="api-reference-toggle" style="color: inherit; text-decoration: none;">\r
                            <span>▶ </span><span i18n="javascriptApiReference"></span>\r
                        </a>\r
                    </div>\r
                </div>\r
                <div class="content_wrapper" id="api-reference-content" style="display: none;">\r
                    <div class="note">\r
                        <div class="note_spacer">\r
                            <h4 i18n="javascriptQuickReference"></h4>\r
\r
                            <h5 i18n="javascriptFlightParameters"></h5>\r
                            <pre>inav.flight.homeDistance  // meters\r
inav.flight.altitude      // cm\r
inav.flight.vbat          // centivolts\r
inav.flight.cellVoltage   // centivolts\r
inav.flight.rssi          // 0-99\r
inav.flight.mode.failsafe // boolean</pre>\r
\r
                            <h5 i18n="javascriptRcChannels"></h5>\r
                            <pre>inav.rc[5].high   // boolean\r
inav.rc[5].mid    // boolean\r
inav.rc[5].low    // boolean\r
inav.rc[5].value  // 1000-2000</pre>\r
\r
                            <h5 i18n="javascriptOverrides"></h5>\r
                            <pre>inav.override.vtx.power = 3;           // 0-4\r
inav.override.throttleScale = 50;      // 0-100%\r
inav.override.yaw.angle = 180;         // degrees\r
inav.override.rcChannel[8] = 2000;     // trigger switch</pre>\r
\r
                            <h5 i18n="javascriptGlobalVariables"></h5>\r
                            <pre>inav.gvar[0] = 100;        // write\r
const x = inav.gvar[0];    // read</pre>\r
\r
\r
                            <h5 i18n="javascriptCompleteExample"></h5>\r
                            <pre>if (inav.flight.homeDistance > 100) {\r
