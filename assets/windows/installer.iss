; ------------------------------------------
; Installer for iNav Configurator
; ------------------------------------------
...
#define CompanyUrl "https://github.com/inavflight"
#define ExecutableFileName "inav-configurator.exe"
#define GroupName "iNav"
#define InstallerFileName "iNav-configurator-installer_" + version + "_" + archName
