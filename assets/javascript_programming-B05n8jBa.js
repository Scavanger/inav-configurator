...
\r
const { flight, override, rc, gvar, waypoint, pid, helpers, events } = inav;\r
\r
...
\r
        // Parse and load transpiled commands\r
...
\r
                        // Add getter methods that MSPHelper expects\r
...
\r
    cleanup: function (callback) {\r
        const self = this;\r
\r
        // Check for unsaved changes\r
        if (this.isDirty) {\r
            const confirmMsg = i18n.getMessage('unsavedChanges') ||\r
                'You have unsaved changes. Leave anyway?';\r
            if (!confirm(confirmMsg)) {\r
                // Cancel navigation\r
                return;\r
            }\r
