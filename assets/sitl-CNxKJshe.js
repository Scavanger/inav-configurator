    ...
    <div class="content_wrapper">\r
        ...
        <div class="note" style="margin-bottom: 20px;">\r
            <div class="note_spacer">\r
                ...
                <p id="sitlWebAssemblyInfo" style="display: none;" data-i18n="sitlWebAssemblyInfo"></p>\r
            </div>\r
        </div>\r
        <div class="leftWrapper">\r
            ...
            <div class="config-section gui_box grey">\r
                ...
                <div class="spacer_box">\r
                    <div id="wasmProxy" class="checkbox is-hidden">\r
                        <input type="checkbox" id="sitlEnableWasmProxy" class="toggle" data-live="true">\r
                        <label for="sitlEnableWasmProxy"><span data-i18n="sitlEnableWasmProxy"></span></label>\r
                        <div class="helpicon cf_tip" data-i18n_title="sitlEnableWasmProxyHelp"></div>\r
                    </div>\r
                    <div id="wasmProxyPort" class="number is-hidden">\r
                        <input type="number" id="sitlWasmProxyPort" data-setting-multiplier="1" step="1" min="1" max="64500" />\r
                        <label for="sitlWasmProxyPort" class="sitlNumber"><span data-i18n="sitlWasmProxyPort"></span></label>\r
                        <div class="helpicon cf_tip" data-i18n_title="sitlWasmProxyPortHelp"></div>\r
                    </div>\r
...
\r
            ...
            <div id="eepromFiles" class="config-section gui_box grey is-hidden">\r
                <div class="gui_box_titlebar">\r
                    <div class="spacer_box_title" data-i18n="sitlEepromFiles"></div>\r
                    <div class="helpicon cf_tip" data-i18n_title="sitlEepromFilesHelp"></div>\r
                </div>\r
                <div class="spacer_box">\r
                    <table id="eepromFiles-table" class="map-table">\r
                        <thead>\r
                            <tr>\r
                                <th style="width: 200px" data-i18n="sitlEepromFileName"></th>\r
                                <th style="width: 100px" data-i18n="sitlEepromActions"></th>\r
                            </tr>\r
                        </thead>\r
                        <tbody class="eepromFilesTableBody">\r
\r
                        </tbody>\r
                    </table>\r
                </div>\r
            </div>\r
            <div id="serialReceiver" class="config-section gui_box grey">\r
                <div class="gui_box_titlebar">\r
