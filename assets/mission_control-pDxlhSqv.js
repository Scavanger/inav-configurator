...
\r
        ...
        $('#removeAllPoints').on('click', function () {\r
            if (markers.length && dialog.confirm(i18n.getMessage('confirm_delete_all_points'))) {\r
...
\r
                if (missionEndFlagCount > 1) {\r
                    if (multimissionCount && ! dialog.confirm(i18n.getMessage('confirm_multimission_file_load'))) {\r
                        mission.flush();\r
                        return;\r
                    } else {\r
        ...
        if ($('#missionPlannerElevation').is(":visible") && !disableMarkerEdit) {\r
            if (mission.isEmpty()) {\r
                ...
                var layout = {showlegend: true,\r
                              ...
                              title: 'Mission Elevation Profile',\r
                              xaxis: {\r
                                title: 'Distance (m)'\r
                              },\r
                              yaxis: {\r
                ...
                //Plotly.newPlot('elevationDiv', data, layout);\r
\r
                var ctx = $("#elevationChart").get(0);\r
\r
                new Chart(ctx, {\r
                    type: 'line',\r
                    data: {\r
                      labels: ['Red', 'Blue', 'Yellow', 'Green', 'Purple', 'Orange'],\r
                      datasets: [\r
                        {\r
                        label: 'One',\r
                        data: [12, 19, 3, 5, 2, 3],\r
                        borderWidth: 1,\r
                        fill: 'start',\r
                        },\r
                        {\r
                            label: 'Two',\r
                            data: [13, 21, 7, 7, 3, 6],\r
                            borderWidth: 2,\r
                            radius: 0\r
                        }\r
                    ]\r
                ...
                (async () => {\r
                    ...
                    let x_elevation = Array.from(Array(samples+1), (_,i)=> i*totalMissionDistance/samples);\r
                    var trace_WGS84 = {\r
                        x: x_elevation,\r
                        y: elevation,\r
                        type: 'scatter',\r
                        name: 'WGS84 elevation',\r
                        hovertemplate: '<b>Elevation</b>: %{y} m',\r
                        fill: 'tozeroy',\r
                        line: {\r
                            color: '#ff7f0e',\r
                        },\r
                    };\r
                    let y_missionElevation = altPoint2measure.map((x,i) => x / 100 + HOME.getAlt()*(1-refPoint2measure[i]));\r
                    let y_elevationReference = refPoint2measure.map((x,i) => (x == 1 ? "WGS84" : "Take-off Home"));\r
                    var trace_missionHeight = {\r
                        x: lengthMission,\r
                        y: y_missionElevation ,\r
                        type: 'scatter',\r
                        mode: 'lines+markers+text',\r
                        name: 'Mission altitude',\r
                        text: namePoint2measure,\r
                        textposition: 'top center',\r
                        textfont: {\r
                            family:  'Raleway, sans-serif'\r
                        },\r
                        customdata: y_elevationReference,\r
                        hovertemplate: '<b>WP</b>: %{text}' +\r
                                '<br><b>Elevation</b>: %{y} m<br>' +\r
                                '<b>Reference</b>: %{customdata}',\r
                        line: {\r
                            color: '#1497f1',\r
                        },\r
                        marker: {\r
                    ...
                    var layout = {showlegend: true,\r
                                  ...
                                  title: 'Mission' + missionNumber + ' Elevation Profile',\r
                                  xaxis: {\r
                                    title: 'Distance (m)'\r
                                  },\r
                                  yaxis: {\r
                                    title: 'Elevation (m)',\r
                                    range: [-10 + Math.min(Math.min(...y_missionElevation), Math.min(...elevation)), 10 + Math.max(Math.max(...y_missionElevation), Math.max(...elevation))],\r
                                  },\r
                                  height: 300,\r
                                  }\r
\r
                    var data = [trace_WGS84, trace_missionHeight];\r
\r
                    //Plotly.newPlot('elevationDiv', data, layout);\r
                })()\r
            }\r
