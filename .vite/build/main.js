import fs, { chmod, rm } from "node:fs";
import electron, { app as app$1, BrowserWindow, Menu, MenuItem, shell as shell$1, ipcMain as ipcMain$1, dialog } from "electron";
...
function requireElectronWindowState() {
  ...
  electronWindowState = function(options) {
    ...
    const fullStoreFileName = path$12.join(config.path, config.file);
    ...
    function saveState(win) {
      ...
      try {
        mkdirp2.sync(path$12.dirname(fullStoreFileName));
...
function requireDist$d() {
  if (hasRequiredDist$d) return dist$d.exports;
  hasRequiredDist$d = 1;
  (function(module, exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
  ...
  })(dist$d, dist$d.exports);
  return dist$d.exports;
}
var distExports$2 = requireDist$d();
...
function requireElectronSquirrelStartup() {
  ...
  var path$12 = path;
  var spawn2 = require$$1$4.spawn;
  var debug2 = requireSrc$2()("electron-squirrel-startup");
  var app2 = electron.app;
...
const tcp = {
  _socket: null,
  _id: 1,
  connect: function(host, port, window2, setNoDelay = true) {
    return new Promise((resolve2) => {
      try {
        this._socket = require$$4$1.connect({ host, port }, () => {
          this._socket.setNoDelay(setNoDelay);
        });
        this._socket.on("error", (error) => {
          if (!window2.isDestroyed()) {
            window2.webContents.send("tcpError", error);
          }
        });
        this._socket.on("end", () => {
          if (!window2.isDestroyed()) {
            window2.webContents.send("tcpEnd");
          }
        });
        this._socket.on("data", (buffer) => {
          if (!window2.isDestroyed()) {
            window2.webContents.send("tcpData", buffer);
          }
        });
        resolve2({ error: false, id: this._id++ });
      } catch (err) {
        resolve2({ error: true, errorMsg: err });
      }
    });
  },
  close: function() {
    ...
    return new Promise((resolve2) => {
      if (this._socket && !this._socket.destroyed) {
        this._socket.write(Buffer.from(data), () => {
          resolve2({ error: false, bytesWritten: data.byteLength });
        });
      } else {
        resolve2({ error: true, msg: "Socket closed or invalid" });
      }
    });
  }
};
...
const udp = {
  ...
  _ip: false,
  _port: false,
  connect: function(ip, port, window2 = true) {
    return new Promise((resolve2) => {
      try {
        socket.bind(port, () => {
          this._ip = ip;
        ...
        socket.on("error", (error) => {
          if (!window2.isDestroyed()) {
            window2.webContents.send("udpError", error);
          }
        });
        socket.on("message", (message, _rinfo) => {
          if (!window2.isDestroyed()) {
            window2.webContents.send("udpMessage", message);
          }
        });
        resolve2({ error: false, id: this._id++ });
      } catch (err) {
  ...
  close: function() {
    return new Promise((resolve2) => {
      try {
        socket.disconnect();
        resolve2({ error: false });
      } catch (err) {
        resolve2({ error: true, msg: err });
      }
    });
  },
  send: function(data) {
...
function requireDist$c() {
  ...
  dist$b.ByteLengthParser = void 0;
  ...
  dist$b.ByteLengthParser = ByteLengthParser;
  return dist$b;
}
var dist$a = {};
...
function requireDist$b() {
  ...
  dist$a.CCTalkParser = CCTalkParser;
  return dist$a;
}
var dist$9 = {};
...
function requireDist$a() {
  ...
  dist$9.DelimiterParser = DelimiterParser;
  return dist$9;
}
var dist$8 = {};
...
function requireDist$9() {
  ...
  dist$8.InterByteTimeoutParser = void 0;
  const stream_1 = require$$0$2;
  ...
  dist$8.InterByteTimeoutParser = InterByteTimeoutParser;
  return dist$8;
}
var dist$7 = {};
...
function requireDist$8() {
  ...
  dist$7.PacketLengthParser = void 0;
  const stream_1 = require$$0$2;
  ...
  dist$7.PacketLengthParser = PacketLengthParser;
  return dist$7;
}
var dist$6 = {};
...
function requireDist$7() {
  ...
  dist$6.ReadlineParser = void 0;
  const parser_delimiter_1 = requireDist$a();
  ...
  dist$6.ReadlineParser = ReadlineParser;
  return dist$6;
}
var dist$5 = {};
...
function requireDist$6() {
  ...
  dist$5.ReadyParser = ReadyParser;
  return dist$5;
}
var dist$4 = {};
...
function requireDist$5() {
  ...
  dist$4.RegexParser = RegexParser;
  return dist$4;
}
var dist$3 = {};
var decoder = {};
...
function requireDist$3() {
  ...
  dist$2.SpacePacketParser = void 0;
  const stream_1 = require$$0$2;
  ...
  dist$2.SpacePacketParser = SpacePacketParser;
  return dist$2;
}
var serialportMock = {};
var dist$1 = {};
...
function requireDist$2() {
  ...
  dist$1.SerialPortStream = dist$1.DisconnectedError = void 0;
  const stream_1 = require$$0$2;
  const debug_12 = __importDefault(requireSrc$1());
  const debug2 = (0, debug_12.default)("serialport/stream");
  ...
  dist$1.DisconnectedError = DisconnectedError;
  ...
  class SerialPortStream extends stream_1.Duplex {
    ...
    open(openCallback) {
      ...
      this.opening = true;
      debug2("opening", `path: ${this.path}`);
      this.settings.binding.open(openOptions).then((port) => {
        debug2("opened", `path: ${this.path}`);
        this.port = port;
        this.opening = false;
        this.emit("open");
        if (openCallback) {
        ...
        this.opening = false;
        debug2("Binding #open had an error", err);
    ...
    update(options, callback) {
      if (!this.isOpen || !this.port) {
        debug2("update attempted, but port is not open");
        return this._asyncError(new Error("Port is not open"), callback);
      }
      debug2("update", `baudRate: ${options.baudRate}`);
      this.port.update(options).then(() => {
        debug2("binding.update", "finished");
        this.settings.baudRate = options.baudRate;
        if (callback) {
          callback.call(this, null);
        }
      }, (err) => {
        debug2("binding.update", "error", err);
    ...
    _write(data, encoding, callback) {
      ...
      debug2("_write", `${data.length} bytes of data`);
      this.port.write(data).then(() => {
        debug2("binding.write", "write finished");
        callback(null);
      }, (err) => {
        debug2("binding.write", "error", err);
        if (!err.canceled) {
    ...
    _read(bytesToRead) {
      ...
      if (!this._pool || this._pool.length - this._pool.used < this._kMinPoolSpace) {
        debug2("_read", "discarding the read buffer pool because it is below kMinPoolSpace");
        this._pool = allocNewReadPool(this.settings.highWaterMark);
      }
      const pool = this._pool;
      const toRead = Math.min(pool.length - pool.used, bytesToRead);
      const start = pool.used;
      debug2("_read", "reading", { start, toRead });
      this.port.read(pool, start, toRead).then(({ bytesRead }) => {
        debug2("binding.read", "finished", { bytesRead });
        if (bytesRead === 0) {
          debug2("binding.read", "Zero bytes read closing readable stream");
          this.push(null);
          return;
        }
        pool.used += bytesRead;
    ...
    _disconnected(err) {
      if (!this.isOpen) {
        debug2("disconnected aborted because already closed", err);
        return;
      }
      debug2("disconnected", err);
    ...
    close(callback, disconnectError = null) {
      if (!this.isOpen || !this.port) {
        debug2("close attempted, but port is not open");
        return this._asyncError(new Error("Port is not open"), callback);
      }
      this.closing = true;
      debug2("#close");
      this.port.close().then(() => {
        ...
        this.closing = false;
        debug2("binding.close", "had an error", err);
        return this._error(err, callback);
      });
    }
    /**
    ...
    set(options, callback) {
      if (!this.isOpen || !this.port) {
        debug2("set attempted, but port is not open");
        return this._asyncError(new Error("Port is not open"), callback);
      }
      const settings = { ...defaultSetFlags, ...options };
      debug2("#set", settings);
      this.port.set(settings).then(() => {
        debug2("binding.set", "finished");
        if (callback) {
          callback.call(this, null);
        }
      }, (err) => {
        debug2("binding.set", "had an error", err);
        return this._error(err, callback);
      });
    }
    /**
    ...
    get(callback) {
      if (!this.isOpen || !this.port) {
        debug2("get attempted, but port is not open");
        return this._asyncError(new Error("Port is not open"), callback);
      }
      debug2("#get");
      this.port.get().then((status) => {
        debug2("binding.get", "finished");
        callback.call(this, null, status);
      }, (err) => {
        debug2("binding.get", "had an error", err);
        return this._error(err, callback);
      });
    }
    /**
    ...
    flush(callback) {
      if (!this.isOpen || !this.port) {
        debug2("flush attempted, but port is not open");
        return this._asyncError(new Error("Port is not open"), callback);
      }
      debug2("#flush");
      this.port.flush().then(() => {
        debug2("binding.flush", "finished");
        if (callback) {
          callback.call(this, null);
        }
      }, (err) => {
        debug2("binding.flush", "had an error", err);
        return this._error(err, callback);
      });
    }
    /**
    ...
    drain(callback) {
      debug2("drain");
      if (!this.isOpen || !this.port) {
        debug2("drain queuing on port open");
        this.once("open", () => {
          this.drain(callback);
        });
        return;
      ...
      this.port.drain().then(() => {
        debug2("binding.drain", "finished");
        if (callback) {
          callback.call(this, null);
        }
      }, (err) => {
        debug2("binding.drain", "had an error", err);
        return this._error(err, callback);
      });
    }
  }
  dist$1.SerialPortStream = SerialPortStream;
  return dist$1;
}
var dist = {};
var src = { exports: {} };
...
function requireDist$1() {
  ...
  const debug2 = debugFactory__default["default"]("serialport/binding-mock");
  let ports = {};
  let serialNumber = 0;
  ...
  const MockBinding = {
    ...
    createPort(path2, options = {}) {
      ...
      debug2(serialNumber, "created port", JSON.stringify({ path: path2, opt: options }));
    },
    async list() {
      debug2(null, "list");
    ...
    async open(options) {
      ...
      debug2(null, `open: opening path ${path2}`);
      ...
      if ((_a = port.openOpt) === null || _a === void 0 ? void 0 : _a.lock) {
        debug2(serialNumber2, "open: Port is locked cannot open");
        throw new Error("Port is locked cannot open");
      }
      debug2(serialNumber2, `open: opened path ${path2}`);
  ...
  class MockPortBinding {
    constructor(port, openOptions) {
      ...
      if (port.readyData) {
        ...
        process.nextTick(() => {
          if (this.isOpen) {
            debug2(this.serialNumber, "emitting ready data");
            this.emitData(data);
          }
        });
      }
    ...
    emitData(data) {
      ...
      debug2(this.serialNumber, "emitting data - pending read:", Boolean(this.pendingRead));
    ...
    async close() {
      debug2(this.serialNumber, "close");
      if (!this.isOpen) {
      ...
      debug2(this.serialNumber, "port is closed");
    ...
    async read(buffer, offset, length) {
      ...
      debug2(this.serialNumber, "read", length, "bytes");
      await resolveNextTick();
      if (!this.isOpen || !this.port) {
      ...
      debug2(this.serialNumber, "read", bytesRead, "bytes");
    ...
    async write(buffer) {
      ...
      debug2(this.serialNumber, "write", buffer.length, "bytes");
      ...
      this.writeOperation = (async () => {
        ...
        this.writeOperation = null;
        debug2(this.serialNumber, "writing finished");
      })();
    ...
    async update(options) {
      ...
      debug2(this.serialNumber, "update");
      if (!this.isOpen || !this.port) {
        throw new Error("Port is not open");
      }
      await resolveNextTick();
    ...
    async getBaudRate() {
      var _a;
      debug2(this.serialNumber, "getBaudRate");
      if (!this.isOpen || !this.port) {
        throw new Error("Port is not open");
      }
      await resolveNextTick();
    ...
    async flush() {
      debug2(this.serialNumber, "flush");
      if (!this.isOpen || !this.port) {
        throw new Error("Port is not open");
      }
      await resolveNextTick();
    ...
    async drain() {
      debug2(this.serialNumber, "drain");
      if (!this.isOpen) {
        throw new Error("Port is not open");
      }
  ...
  dist.CanceledError = CanceledError;
  dist.MockBinding = MockBinding;
  dist.MockPortBinding = MockPortBinding;
  return dist;
}
...
function requireSerialportMock() {
  ...
  const stream_1 = requireDist$2();
  const binding_mock_1 = requireDist$1();
...
const __esModule = _M_.__esModule;
const autoDetect = _M_.autoDetect;
const DarwinBinding = _M_.DarwinBinding;
const DarwinPortBinding = _M_.DarwinPortBinding;
const LinuxBinding = _M_.LinuxBinding;
const LinuxPortBinding = _M_.LinuxPortBinding;
const WindowsBinding = _M_.WindowsBinding;
const WindowsPortBinding = _M_.WindowsPortBinding;
const BindingsError = _M_.BindingsError;
const keyword_default = _M_.default || _M_;
const bindingsCpp_interop = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  BindingsError,
  DarwinBinding,
  DarwinPortBinding,
...
const require$$1 = /* @__PURE__ */ getAugmentedNamespace(bindingsCpp_interop);
...
function requireSerialport() {
  ...
  const stream_1 = requireDist$2();
  const bindings_cpp_1 = require$$1;
...
function requireDist() {
  ...
  (function(exports) {
    ...
    var __exportStar = dist$c && dist$c.__exportStar || function(m, exports2) {
      for (var p in m) if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p)) __createBinding(exports2, m, p);
    };
    Object.defineProperty(exports, "__esModule", { value: true });
...
const serial = {
  _serialport: null,
  _id: 1,
  connect: function(path2, options, window2) {
    return new Promise((resolve2) => {
      try {
        this._serialport = new distExports.SerialPortStream({ binding, path: path2, baudRate: options.bitrate, autoOpen: true });
        this._serialport.on("error", (error) => {
          if (!window2.isDestroyed()) {
            window2.webContents.send("serialError", error);
          }
        });
        this._serialport.on("close", () => {
          if (!window2.isDestroyed()) {
            window2.webContents.send("serialClose");
          }
        });
        this._serialport.on("data", (buffer) => {
          if (!window2.isDestroyed()) {
            window2.webContents.send("serialData", buffer);
          }
        });
        resolve2({ error: false, id: this._id++ });
      } catch (err) {
    ...
    return new Promise((resolve2) => {
      if (this._serialport && this._serialport.isOpen) {
        this._serialport.write(Buffer.from(data), (error) => {
          if (error) {
            resolve2({ error: true, msg: `Serial write error: ${error}` });
          } else {
            resolve2({ error: false, bytesWritten: data.byteLength });
          }
        });
      } else {
        resolve2({ error: true, msg: "Invalid serial port or port closed" });
      }
    });
  },
...
const child_process = {
  _processes: [],
  start: function(command, args, opts, window2) {
    var process2;
    try {
      process2 = spawn(command, args, opts);
    } catch (err) {
      console.log(err);
      return -1;
    }
    this._processes.push(process2);
    process2.stdout.on("data", (data) => {
      if (!window2.isDestroyed()) {
        window2.webContents.send("onChildProcessStdout", data.toString());
      }
    });
    process2.stderr.on("data", (data) => {
      if (!window2.isDestroyed()) {
        window2.webContents.send("onChildProcessStderr", data.toString());
      }
    });
    process2.on("error", (error) => {
      if (!window2.isDestroyed()) {
        window2.webContents.send("onChildProcessError", error);
      }
    });
  },
  stop: function() {
    for (const process2 of this._processes) {
      if (process2) {
        try {
          process2.kill();
        } catch (err) {
...
function createDeviceChooser() {
  ...
  {
    bluetoothDeviceChooser.loadURL(`${"http://localhost:5173"}/js/libraries/bluetooth-device-chooser/bt-device-chooser-index.html`);
  }
  ...
  ipcMain$1.on("deviceSelected", (_event, deviceID) => {
    if (selectBluetoothCallback) {
...
function createWindow() {
  ...
  app$1.commandLine.appendSwitch("disable-features", "OutOfBlinkCors");
  if (process.platform === "linux") {
...
app$1.whenReady().then(() => {
  ipcMain$1.handle("listSerialDevices", (_event) => {
    return serial.getDevices();
  });
  ipcMain$1.on("storeGet", (event, key, defaultVale) => {
    event.returnValue = store.get(key, defaultVale);
  });
  ipcMain$1.on("storeSet", (_event, key, value) => {
    store.set(key, value);
  });
  ipcMain$1.on("storeDelete", (_event, key) => {
    store.delete(key);
  });
  ipcMain$1.on("appGetPath", (event, name) => {
    event.returnValue = app$1.getPath(name);
  });
  ipcMain$1.on("appGetVersion", (event) => {
    event.returnValue = app$1.getVersion();
  });
  ipcMain$1.on("appGetLocale", (event) => {
    event.returnValue = app$1.getLocale();
  });
  ipcMain$1.handle("dialog.showOpenDialog", (_event, options) => {
    return dialog.showOpenDialog(options);
  }), ipcMain$1.handle("dialog.showSaveDialog", (_event, options) => {
    return dialog.showSaveDialog(options);
  }), ipcMain$1.on("dialog.alert", (event, message) => {
    event.returnValue = dialog.showMessageBoxSync({ message, icon: path.join(__dirname, "inav_icon_128.png") });
  });
  ipcMain$1.on("dialog.confirm", (event, message) => {
    event.returnValue = dialog.showMessageBoxSync({ message, icon: path.join(__dirname, "inav_icon_128.png"), buttons: ["Yes", "No"] }) == 0;
  });
  ipcMain$1.handle("tcpConnect", (_event, host, port) => {
    return tcp.connect(host, port, mainWindow);
  });
  ipcMain$1.handle("tcpSend", (_event, data) => {
    return tcp.send(data);
  });
  ipcMain$1.on("tcpClose", (_event) => {
    tcp.close();
  });
  ipcMain$1.handle("serialConnect", (_event, path2, options) => {
    return serial.connect(path2, options, mainWindow);
  });
  ipcMain$1.handle("serialSend", (_event, data) => {
    return serial.send(data);
  });
  ipcMain$1.handle("serialClose", (_event) => {
    return serial.close();
  });
  ipcMain$1.handle("udpConnect", (_event, ip, port) => {
    return udp.connect(ip, port, mainWindow);
  });
  ipcMain$1.handle("udpSend", (_event, data) => {
    return udp.send(data);
  });
  ipcMain$1.on("udpClose", (_event) => {
    udp.close();
  });
  ipcMain$1.handle("writeFile", (_event, filename, data) => {
  ...
  ipcMain$1.handle("readFile", (_event, filename, encoding) => {
    return new Promise(async (resolve2) => {
      try {
        const data = await readFile(filename, { encoding });
        resolve2({ error: false, data });
      } catch (err) {
        resolve2({ error: err });
      }
    });
  });
  ipcMain$1.handle("chmod", (_event, pathName, mode) => {
    return new Promise((resolve2) => {
      chmod(path.join(__dirname, "sitl", pathName), mode, (error) => {
        if (error) {
          resolve2(error.message);
        } else {
          resolve2(false);
        }
      });
  ...
  ipcMain$1.handle("rm", (_event, path2) => {
    return new Promise((resolve2) => {
      rm(path2, (error) => {
        if (error) {
          resolve2(error.message);
  ...
  ipcMain$1.on("startChildProcess", (_event, command, args, opts) => {
    child_process.start(path.join(__dirname, "sitl", command), args, opts, mainWindow);
  });
  ipcMain$1.on("killChildProcess", (_event) => {
    child_process.stop();
  });
